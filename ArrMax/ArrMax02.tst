// Test case 2 for ArrMax.vm
// maximum value in an array of size 3
...
set RAM[18] 3,     // static 2 (array size = 3)
...
set RAM[2048] 6,   // Arr[0]
set RAM[2049] 29,  // Arr[1] (max)
set RAM[2050] 15;  // Arr[2]
