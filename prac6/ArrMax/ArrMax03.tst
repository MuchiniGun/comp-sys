// Test case 3 for ArrMax.vm
// maximum value in an array of size 5
...
set RAM[17] 2048,  // static 1 (pointer to array start)
set RAM[18] 5,     // static 2 (array size = 5)
...
set RAM[2048] 22,  // Arr[0]
set RAM[2049] 18,  // Arr[1]
set RAM[2050] 7,   // Arr[2]
set RAM[2051] 34,  // Arr[3]
set RAM[2052] 30;  // Arr[4] (max)
